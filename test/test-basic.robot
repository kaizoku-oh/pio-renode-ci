...
Start Test
    ...
    Execute Command                              machine LoadPlatformDescription @${PWD_PATH}/scripts/add-ccm.repl
    Execute Command                              sysbus LoadELF @${PWD_PATH}/.pio/build/disco_f407vg/firmware.elf
...
Should Handle Button Press
    [Documentation]                              Test button press
    [Tags]                                       non_critical  uart  input  gpio
